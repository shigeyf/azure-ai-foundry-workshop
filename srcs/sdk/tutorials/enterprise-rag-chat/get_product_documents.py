...
def get_product_documents(messages: list, context: dict = None) -> dict:
    ...
    logger.debug("🧠 Intent mapping: %s", search_query)

    # generate a vector representation of the search query
    embedding = embeddings.embed(
        model=os.environ["EMBEDDINGS_MODEL"], input=search_query)
    ...
    # add thoughts and documents to the context object
    ...
    logger.debug("📄 %d documents retrieved: %s", len(documents), documents)
    return documents
